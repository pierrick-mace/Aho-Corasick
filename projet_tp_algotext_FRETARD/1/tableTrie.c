...
Trie createTrie(int maxNode) {
    ...
    for (bool* p = newTrie -> finite; p < newTrie -> finite + maxNode; ++p) {
        *p = false;
    }
...
static size_t _hashFunc(int node, unsigned char letter) {
